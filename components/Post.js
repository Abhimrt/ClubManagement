                        ...
                        <div className="p-5 ">
                            ...
                            <>
                                <div className='flex flex-wrap justify-between items-center text-lg text-gray-900 my-2'>
                                    ...
                                    <p className='mr-5'>Time: <span className='text-blue-700' >{tConv24(e.time)}</span></p>

                                </div>
                                <div className='flex flex-wrap justify-between items-center text-lg text-gray-900 my-2'>
                                    <p className=''>Mode: <span className='text-blue-700' > {e.mode}</span></p>
                                    <p className='mr-5'>Registration: <a href={"e.link"} className='text-blue-700' > click me</a></p>

                                </div>
                                <div className='flex flex-wrap justify-between items-center text-lg text-gray-900 my-2'>
                                    <p className=''>Location: <span className='text-blue-700' > {e.location}</span></p>
                                    <p className='mr-5'>Contact: <span className='text-blue-700' > {e.contact}</span></p>
                                </div>
                            </>
